...
if __name__ == "__main__":
    ...
    obj2 = OB.Object_container(objList = (
        OWF.Object_wireFrame(filename="./objects/cube.json", color=(190,190,190)).translate(V=(0,0,0), initShape=True),       #< Body
        OWF.Object_wireFrame(filename="./objects/pyramid.json", color=(90,90,90)).translate(V=(0,-250,0), initShape=True), #< Roof
        OWF.Object_wireFrame(filename="./objects/frame.json", color=(200,0,0)).translate(V=(0,0,-100), initShape=True),   #< Window
        ),
